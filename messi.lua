...
local Themes = {
	...
	Neon = {
		...
		AcrylicMain = Color3.fromRGB(20, 20, 20),
		AcrylicBorder = Color3.fromRGB(60, 60, 60),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(10, 10, 10), Color3.fromRGB(20, 20, 20)),
		AcrylicNoise = 0.92,
		...
		Input = Color3.fromRGB(80, 80, 80),
		InputFocused = Color3.fromRGB(10, 10, 10),
		InputIndicator = Color3.fromRGB(100, 100, 100),
		InputIndicatorFocus = Color3.fromRGB(0, 255, 255),
...
Components.Tab = (function()
	...
	function TabModule:New(Title, Icon, Parent)
		...
		Creator.AddSignal(ContainerLayout:GetPropertyChangedSignal("AbsoluteContentSize"), function()
			Tab.ContainerFrame.CanvasSize = UDim2.fromScale(0, ContainerLayout.AbsoluteContentSize.Y + 2)
		end)
...
ElementsTable.Toggle = (function()
	...
	function Element:New(Idx, Config)
		...
		function Toggle:SetValue(Value)
			...
			TweenService:Create(
				ToggleCircle,
				TweenInfo.new(0.25, Enum.EasingStyle.Expo, Enum.EasingDirection.Out),
...
ElementsTable.Slider = (function()
	...
	function Element:New(Idx, Config)
		...
		local Slider = {
			...
			Callback = Config.Callback or function(Value) end,
			Changed = Config.Changed or function(Value) end,
			Type = "Slider",
		}
		...
		local ScaleMotor = Flipper.SingleMotor.new((Config.Default - Slider.Min) / (Slider.Max - Slider.Min))

		ScaleMotor:onStep(function(value)
			SliderDot.Position = UDim2.new(value, -7, 0.5, 0)
		...
		function Slider:SetValue(Value)
			...
			ScaleMotor:setGoal(Flipper.Spring.new((self.Value - Slider.Min) / (Slider.Max - Slider.Min), { frequency = 4 }))
